...
const DarkModeToggle = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <motion.button
      ...
      aria-label={
        isDarkMode ? "تبديل إلى الوضع الفاتح" : "تبديل إلى الوض�� الداكن"
      }
    >
      <motion.div
        initial={false}
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مؤسسة المعهد",
                content:
                  "تصاميم رائعة وأفكار مبتكرة! ساعدونا في جذب الطلا�� الجدد وبناء سمعة قوية في السوق التعليمي.",
                rating: 5,
                image:
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نسعد بتلقي آرائكم واقتراحا��كم لتطوير خدماتنا وتحسين تجربتكم معنا
            </p>
          </motion.div>
              ...
              {[
                {
                  ...
                  description: "اقتراحات حول جودة التصاميم وأسال��ب الإبداع",
                  color: "from-pink-500 to-rose-500",
                },
                {
                  icon: "⚡",
