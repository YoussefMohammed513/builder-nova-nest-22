          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية ومؤثرة تلامس قلوب الجمهور وتحقق الن��ائج المرجوة في عالم
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نخبة من ال��بدعين والمتخصصين في مجالات التصميم والتسويق الرقمي
              والتطوير التقني
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "صاحب المؤسسة",
                content:
                  "فريق متفهم لاحتياجاتنا، سرعة في التنفيذ وجودة عالية ��ي العمل. نوصي بهم بشدة لكل من يريد التمي��.",
                rating: 5,
                image:
                  "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
                date: "منذ شهرين",
