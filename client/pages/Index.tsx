          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية ومؤثرة تلامس قلوب الجمهور وتحقق النتائج المرج��ة في عالم
            ...
            {[
              {
                ...
                description:
                  "شعارات وهويات بصرية متكام��ة تعكس شخصية علامتك التجارية وتميزك عن المنافسين في السوق المحلي والعالمي",
                features: [
              ...
              },
              {
                ...
                description:
                  "فيديوهات احترافية وموشن جرافيك مبتكر يحكي قصة علامتك التجاري�� بطريقة جذابة ومؤثرة تلامس المشاعر",
                features: [
            ...
            {[
              {
                ...
                experience: "قا��د الفريق والرؤية الاستراتيجية",
                image:
              ...
              },
              {
                ...
                experience: "استراتيجي التسويق ال��قمي",
                image:
