          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية ومؤثرة تلامس قلوب الجمهور وت��قق النتائج المرجوة في عالم
              ...
              <div className="relative overflow-hidden rounded-professional-xl shadow-professional-lg">
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xs">سن��ات خبرة</div>
                  </div>
                </motion.div>
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مديرة العيادة",
                content:
                  "خدمة استثنائية! ساعدونا في بناء ثقة المرضى ��ن خلال التصميم المتميز وإدارة الحسابات الاجتماعية بشكل احترافي.",
                rating: 5,
                image:
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نسعد بتلقي آرائكم و��قتراحاتكم لتطوير خدماتنا وتحسين تجربتكم معنا
            </p>
          </motion.div>
