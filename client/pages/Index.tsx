          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية ومؤثرة تلامس قلوب الج��هور وتحقق النتائج المرجوة في عالم
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مدروسة ومستهدفة عبر جميع المنصات ال��قمية لضمان أفضل عائد استثمار وتحقيق الأهداف المحددة",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "استراتيجية محتوى ج��ابة لعلامة أزياء عصرية",
                client: "Fashion Plus",
                year: "2024",
