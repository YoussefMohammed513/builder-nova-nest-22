...
const DarkModeToggle = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <motion.button
      ...
      aria-label={
        isDarkMode ? "تبدي�� إلى الوضع الفاتح" : "تبديل إلى الوضع الداكن"
      }
    >
      <motion.div
        initial={false}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                تتزايد فيه المنافسة والتحديات يوما�� بعد يوم.
              </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مدروسة ومست��دفة عبر جميع المنصات الرقمية لضمان أفضل عائد استثمار وتحق��ق الأهداف المحددة",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "حملة إبد��عية شاملة لترويج المعرض الفني",
                client: "معرض الإبداع",
                year: "2023",
                tags: ["ف��", "إعلان", "ثقافة"],
              },
          ...
          >
            {[
              ...
              },
              {
                ...
                quote: "التواصل الف��ال هو الجسر بين الأحلام والواقع",
              },
              {
          ...
          >
            {[
              ...
              },
              {
                ...
                date: "منذ شهر",
                project: "تطوير مو��ع إلكتروني متكامل",
              },
              {
