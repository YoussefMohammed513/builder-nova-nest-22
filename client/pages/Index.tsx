...
const DarkModeToggle = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <motion.button
      ...
      aria-label={
        isDarkMode ? "تبديل إلى الوضع الفاتح" : "تبديل إلى الوضع ال��اكن"
      }
    >
      <motion.div
        initial={false}
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مدروس�� ومست��دفة عبر جميع المنصات الرقمية لضمان أفضل عائد استثمار وتحقيق الأهداف المحددة",
                features: [
            ...
            >
              ...
              {[
                ...
                },
                {
                  icon: "⚡",
                  title: "سرعة التنفيذ",
                  description: "أفكار لتحسين أوقات التسليم وكفاءة العم��",
                  color: "from-blue-500 to-cyan-500",
                },
                {
                  icon: "💰",
