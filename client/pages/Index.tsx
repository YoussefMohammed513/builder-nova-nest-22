          ...
          >
            <div className="py-4 space-y-2 scroll-area max-h-96 overflow-y-auto">
              {[
                ...
                { href: "#team", text: "فريقنا", icon: "👥" },
                { href: "#suggestions", text: "اقتراحاتك", icon: "💡" },
                { href: "#contact", text: "��واصل معنا", icon: "📞" },
              ].map((item, index) => (
                <motion.a
                  key={index}
                  href={item.href}
        ...
        <div className="container-padding relative z-10">
          ...
          >
            {[
              ...
              {
                name: "سا��ة أحمد الحداد",
                company: "معهد الإبداع التعليمي",
                role: "مؤسسة المعهد",
                content:
                  "تصام��م رائعة وأفكار مبتكرة! ساعدونا في جذب الطلاب الجد�� وبناء سمعة قوية في السوق التعليمي.",
                rating: 5,
                image:
