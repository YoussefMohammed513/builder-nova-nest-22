                ...
                <div className="flex justify-center gap-4 mt-4 px-4">
                  {[
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.9 }}
                      className={`w-10 h-10 ${social.icon === "💬" ? "bg-green-500 hover:bg-green-600" : "bg-[rgb(var(--surface-variant))] hover:bg-[rgb(var(--brand-primary))]"} rounded-full flex items-center justify-center text-lg hover:text-white transition-colors duration-300 touch-target`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-6 text-pretty">
                ...
                المحتوى الرقمي باحترافية تضاهي ا��معايير العالمية.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                {[
                  ...
                  {
                    title: "السرعة والدقة",
                    desc: "تسل��م في المواعيد المحددة بأعلى جودة",
                    icon: "🚀",
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "محتوى مرئي احترافي وموشن جرافيك مبدع يحكي قصة علامتك التجارية بطريقة جذابة ومؤ��رة تصل إلى قلب جمهورك",
                features: [
        ...
        <div className="container-padding relative z-10">
          ...
          >
            {[
              ...
              {
                title: "مقهى الأصدقاء الحديث",
                category: "هوية بصرية ومحتوى رقمي",
                image:
              ...
              },
              {
                ...
                category: "تصميم تطبيق وحملة تسويقية",
                image:
              ...
              },
              {
                ...
                category: "منصة تعليمية وهوية متكاملة",
                image:
        ...
        <div className="container-padding relative z-10">
          ...
          >
            {[
              ...
              {
                name: "ربيع العيفري",
                role: "مختص تسويق محتوى",
                experience: "خبير في صناعة المحتوى والحملات التسويقية",
                image:
                  "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
                social: ["linkedin", "twitter", "instagram"],
                color: "from-indigo-500 to-purple-500",
                specialties: ["التسويق", "المحتوى", "الحملات"],
                quote: "المحتوى الجيد هو الذي يتحدث إلى القلب قبل العقل",
              },
            ].map((member, index) => (
              <motion.div
                key={index}
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "صاحب المؤسسة",
                content:
                  "فريق متفهم لا��تياجاتنا، سرعة في التنفيذ وجودة عالية في العمل. نوصي بهم بشدة لكل من يريد التميز.",
                rating: 5,
                image:
                  "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
                date: "منذ شهرين",
