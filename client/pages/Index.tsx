          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                تتزايد فيه المنافسة والتحدي��ت يوماً بعد يوم.
              </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مد��وسة ومستهدفة عبر جميع المنصات الرقمية لضمان أفضل عائد استثمار وتحقيق الأهداف المحددة",
                features: [
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="h-1 bg-gradient-brand mx-auto mb-6"
            />
            <h2 className="heading-secondary mb-6">ا��تراحاتك تهمنا</h2>
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              ...
              <div className="grid gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    title: "العنوان",
                    info: "صنعاء، اليمن",
                    description: "نخدم العملاء ف�� جميع أنحاء العالم العربي",
                    color: "from-purple-500 to-violet-500",
                  },
                  {
                    icon: "⏰",
