      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "��كالة إبداعية متخصصة في تصميم الهويات البصرية والتسويق الرقمي",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-6 text-pretty">
                ...
                تجمع بين الإبداع والاحتراف العالمي. نعمل على بناء الهوي��ت
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "استرا��يجيات محتوى مدروسة وإدارة احترافية لحساباتك على منصات التواصل الاجتماعي لزيادة التفاعل والمتابعين",
                features: [
                  "استراتيجية المح��وى المتخصصة",
              ...
              },
              {
                ...
                description:
                  "م��توى مرئي احترافي وموشن جرافيك مبدع يحكي قصة علامتك التجارية بطريقة جذابة ومؤثرة تصل إلى قلب جمهورك",
                features: [
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              شهادات حقيقية من عملائنا الذين حققوا النجاح معنا وش��دوا نمواً
