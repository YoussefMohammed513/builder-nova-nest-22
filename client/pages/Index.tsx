          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "استراتيجيات محتوى مدروسة وإ��ارة احترافية لحساباتك على منصات التواصل الاجتماعي لزيادة التفاعل والمتابعين",
                features: [
              ...
              },
              {
                ...
                title: "تطوير المواقع",
                description:
                  "مواقع إلكترونية عصرية ومتجاوبة مع جميع الأجهزة مع أفضل تجربة مست��دم وتحسين محركات البحث المتقدم",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مالكة الصالون",
                content:
                  "تحسن كبير في حضور��ا الرقمي! زبائن جدد كل يوم بفضل الحملات الإعلانية المدروسة والمحتوى الجذاب.",
                rating: 5,
                image:
            ...
            >
              ...
              {[
                ...
                },
                {
                  ...
                  description: "تطو��ر الموقع وتحسين تجربة المستخدم",
                  color: "from-orange-500 to-red-500",
                },
                {
                  icon: "📈",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-16">
            ...
            >
              ...
              <p className="mb-4 text-sm leading-relaxed">
                اشترك في نشرتنا البريدية ��لحصول على آخر الأخبار والعروض
                الحصرية.
              </p>
