          ...
          >
            {[
              ...
              },
              {
                ...
                features: [
                  "فيسب��ك وإ��ستقرام المتقدم",
                  "جوجل أدوردز المتخصص",
                  "سناب شات وتيك توك الحديث",
                  "يوتي��ب ولين��د إن الاحترافي",
                ],
                image:
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مؤسسة المعهد",
                content:
                  "تصاميم رائعة وأفكار مبتكرة! ساع��ونا في جذب الطلاب الجد�� وبناء سمعة قوية في السوق التعليمي.",
                rating: 5,
                image:
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نسعد بتلقي آرائ��م واقتراحاتكم لتطوير خدماتنا وتحسين تجربتكم معنا
            </p>
          </motion.div>
