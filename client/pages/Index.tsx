        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              قصة نجاح بدأت برؤية واضحة لتقديم أفضل الحلول الإبداعية في ا��منطقة
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "شعارات وهويات بصرية متكاملة تعكس شخصية علام��ك التجارية وتميزك عن المنافسين في السوق ا��محلي والعالمي",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مديرة العيادة",
                content:
                  "خدمة استثنائية! ساعدونا في بناء ثقة المرض�� من خلال التصميم المتميز وإدارة الحسابات الاجتماعية بشكل احترافي.",
                rating: 5,
                image:
