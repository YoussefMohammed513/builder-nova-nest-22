          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية ومؤثرة تلامس ق��وب الجمهور وتحقق النتائج المرجوة في عالم
            ...
            {[
              {
                ...
                description:
                  "شعارات وهويات بصرية متكاملة تعكس شخصية علامتك التجارية وتميزك عن المنافسين في السوق المحلي والعا��مي",
                features: [
