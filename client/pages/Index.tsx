          ...
          >
            <div className="py-4 space-y-2 scroll-area max-h-96 overflow-y-auto">
              {[
                ...
                { href: "#portfolio", text: "أعمالنا", icon: "💼" },
                { href: "#team", text: "فريقنا", icon: "👥" },
                { href: "#suggestions", text: "اقتراح��تك", icon: "💡" },
                { href: "#contact", text: "تواصل معنا", icon: "📞" },
              ].map((item, index) => (
                <motion.a
                  key={index}
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مدروسة ومستهدفة عبر جميع المنصات الرقمية لضمان أفضل عائد استثم��ر وتحقيق الأهداف المحددة",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                quote: "��لتواصل الفعال هو الجسر بين الأحلام والواقع",
              },
              {
            ...
            {[
              {
                ...
                date: "منذ شهرين",
                project: "تصميم هوية ب��رية شاملة",
              },
              {
            ...
            >
              <div>
                ...
                <p className="leading-relaxed text-pretty mb-6">
                  وكال�� إبداعية متخصصة في تصميم الهويات البصرية والتسويق
