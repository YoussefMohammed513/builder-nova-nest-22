      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              ��قدم مجموعة شاملة من الخدمات المتخصصة لبناء علامتك التجارية
            ...
            {[
              {
                ...
                description:
                  "شعارات وهويات بصرية متكاملة تعكس شخصية علام��ك التجارية وتميزك عن المنافسين في السوق المحلي والعالمي",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مديرة العيادة",
                content:
                  "خدمة استثنائية! ساعدونا في بناء ثقة المرضى من خلال التصميم المتميز وإدارة الحسابات الاجتم��عية بشكل اح��رافي.",
                rating: 5,
                image:
              ...
              },
              {
                ...
                company: "معهد ال��بداع التعليمي",
                role: "مؤسسة المعهد",
                content:
                  "تصاميم رائعة وأفكار مبتكرة! ساعدونا في جذب الطلاب الجد�� و��ناء سمعة قوية في السوق التعليمي.",
                rating: 5,
                image:
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نسعد بتلقي آرائكم واقتراحاتكم لتطوير خدمات��ا وتحسين تجربتكم معنا
            </p>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
              {[
                ...
                { number: "48", label: "ساع�� متوسط الرد", icon: "⚡" },
              ].map((stat, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, scale: 0 }}
