          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية ومؤثرة تلامس قلوب الجمهور وتحقق النتائج الم��جوة في عالم
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "مساندة مستمرة لضمان نجاحك ��تميزك",
                    icon: "🤝",
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "استراتيجية محتوى ��ذابة لعلامة أزياء عصرية",
                client: "Fashion Plus",
                year: "2024",
