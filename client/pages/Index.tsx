        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="h-1 bg-gradient-brand mx-auto mb-6"
            />
            <h2 className="heading-secondary mb-6">خدماتنا ��لاحترافية</h2>
            <p className="text-xl max-w-3xl mx-auto text-pretty">
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مدروسة ومستهدفة عبر جميع المنصات الرقمية لضم��ن أفضل عائد استثمار وتحقيق الأهداف المحددة",
                features: [
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              ش��ادات حقيقية من عملائنا الذين حققوا النجاح معن�� وشاهدوا نمو
              أعمالهم
            </p>
          </motion.div>
                ...
                {[
                  {
                    ...
                    description: "م��اح 24/7 للرد على استفساراتك",
                    color: "from-green-500 to-emerald-500",
                  },
                  {
                    icon: "📧",
