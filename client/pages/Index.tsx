          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "حملات إعلانية مدروسة ومستهدفة عبر جميع المنصات الرق��ية لضمان أفضل عائد استثمار وتحقيق الأهداف المحددة",
                features: [
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "صاحب المؤسسة",
                content:
                  "فريق متفهم لاحتياجاتنا، سرعة في التنفيذ وجودة عا��ية في العمل. نوصي بهم بشدة لكل من يريد التميز.",
                rating: 5,
                image:
                  "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
                date: "منذ شهرين",
            ...
            >
              <div>
                ...
                <p className="leading-relaxed text-pretty mb-6">
                  وكالة إبداعية متخصصة في تصميم الهويات البصرية والتسويق الرقمي،
                  نساعدك في بناء علامة تج��رية قوية ومؤثرة.
                </p>
              </div>
