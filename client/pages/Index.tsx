          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="hidden sm:inline">شاهد أعم��ل��ا</span>
        ...
        <div className="container-padding relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-3xl font-bold mb-6">رؤيتنا للم��تقبل</h3>
                ...
                {[
                  {
                    ...
                    desc: "تصاميم مبتكرة تعكس ه��يتك ا��فريدة وتميزك",
                    icon: "🎨",
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "صاحب المؤسسة",
                content:
                  "فريق متف��م لاحتياجاتنا، سرعة في التنفيذ وجودة عالية ��ي العمل. نوصي بهم بشدة لكل من يريد التميز.",
                rating: 5,
                image:
                  "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
                date: "منذ شهرين",
