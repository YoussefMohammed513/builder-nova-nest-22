          ...
          >
            {[
              ...
              },
              {
                ...
                title: "تطوير المواق��",
                description:
                  "مواقع إلكترونية عصرية ومتجاوبة مع جميع الأجهزة مع أفضل تجربة مستخدم وتحسين محركات البحث ال��تقدم",
                features: [
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نخبة من المبدعين والمتخص��ين في مجالات التصميم والتسويق الرقمي
              والتطوير التقني
            </p>
          </motion.div>
