        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              ��صة نجاح بدأت برؤية واضحة لت��ديم أفضل الحلول الإبداعية في
              المنطقة
            </p>
          </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "مس��ندة مست��رة لضمان نجاحك وتميزك",
                    icon: "🤝",
            ...
            >
              <div>
                ...
                <p className="leading-relaxed text-pretty mb-6">
                  وكالة إبداعية متخصصة في تصميم الهويات البصرية والتسويق الرقمي،
                  نساعدك في بناء ع��امة تجارية قوية ومؤثرة.
                </p>
              </div>
