          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                إبداعية وم��ثرة تلامس قلوب الجمهور وتحقق النتائج المرجوة في عالم
            ...
            {[
              {
                ...
                description:
                  "شعارات وهويات بصرية متكاملة تعكس شخصية علامتك التجارية وتميزك عن المناف��ين في السوق المحلي والعالمي",
                features: [
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نخبة من المبدعين و��لمتخصصين في مجالات التصميم والتسويق الرقمي
              والتطوير التقني
            </p>
          </motion.div>
