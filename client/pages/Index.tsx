        ...
        <div className="relative z-10 text-center container-padding">
          ...
          >
            ...
            >
              ...
              >
                <span className="text-lg">🏆</span>
                <span className="hidden sm:inline">أك��ر من 500 عميل راضٍ</span>
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              نقدم مجموعة شام��ة من الخدمات المتخصصة لبناء علامتك التجارية
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مديرة العيادة",
                content:
                  "خدمة استثنائية! ساعدونا في بناء ثقة المرضى من خلال التصميم المتميز وإدارة الحسابات الاجت��اعية بشكل احترافي.",
                rating: 5,
                image:
              ...
              },
              {
                ...
                role: "مالكة الصالون",
                content:
                  "تحسن كبير في حضو��نا الرقمي! زبائن جدد كل يوم بفضل الحملات الإعلانية المدروسة والمحتوى الجذاب.",
                rating: 5,
                image:
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-center md:text-right">
                <p>&copy; 2024 خطوة للدعاية والإعلان. جميع ال��قوق محفوظة.</p>
              </div>
