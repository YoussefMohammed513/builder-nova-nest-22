          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-6 text-pretty">
                ...
                المحتوى الرق��ي باحترافية تضاهي المعايير العالمية.
              </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "استراتيجيات محتوى مدروسة وإدارة احترافية لحساباتك على منصات التواصل الاجتماع�� لزيادة التفاعل والمتابعين",
                features: [
              ...
              },
              {
                ...
                description:
                  "فيديوهات احترافية وموشن ��رافيك مبتكر يحكي قصة علامتك التجارية بطريقة جذابة ومؤثرة تلامس المشاعر",
                features: [
            ...
            {[
              {
                ...
                experience: "قائد الفريق والرؤي�� الاستراتيجية",
                image:
