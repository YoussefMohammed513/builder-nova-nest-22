        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              قصة نجاح بدأت برؤية واضحة لتقديم أفضل الحلول ال��بداعية في المنطقة
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              },
              {
                ...
                color: "from-green-500 to-teal-500",
                specialties: ["التسويق", "ا��حملات", "التحليل"],
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "صاحب المؤسسة",
                content:
                  "فريق متفهم لاحتياجاتنا، سرعة في التنفيذ وجودة عالية ��ي العمل. نو��ي بهم بشدة لكل من يريد التميز.",
                rating: 5,
                image:
                  "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
                date: "منذ شهرين",
