          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg leading-relaxed mb-8 text-pretty">
                ...
                تتزايد فيه المنافسة والتحديات يوم��ً بعد يوم.
              </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                description:
                  "مواد طب��عية عالية الجود�� من الكروت الشخصية إلى اللافتات الكبيرة بأحدث التقنيات والمواد المتطورة",
                features: [
