        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto text-pretty">
              ��صة نجاح بدأت برؤية واضحة لتقديم أفضل الحلول الإبداعية في
              المنط��ة
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                experience: "قائد الفريق وا��رؤية الاستراتيجية",
                image:
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
              {[
                ...
                { number: "15+", label: "شه��دة احترافية", icon: "📜" },
          ...
          >
            {[
              ...
              },
              {
                ...
                role: "مالكة الصالون",
                content:
                  "تحسن كبير في حضورنا الرقمي! زبائن جدد كل يوم بفضل الحملات الإعلانية المدروسة و��لمحتوى الجذاب.",
                rating: 5,
                image:
