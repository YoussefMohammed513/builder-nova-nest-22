...
const DarkModeToggle = ({ isDarkMode, toggleDarkMode }) => {
  return (
    <motion.button
      ...
      aria-label={
        isDarkMode ? "تبديل إلى الوضع الفاتح" : "ت��ديل إلى الوضع الداكن"
      }
    >
      <motion.div
        initial={false}
      ...
      >
        ...
        <div className="container-padding relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto text-pretty">
              جاهزون لتحويل أفكارك إلى واقع مبهر. تواصل م��نا ال💰وم واحصل على
              استشارة مجانية
            </p>
          </motion.div>
