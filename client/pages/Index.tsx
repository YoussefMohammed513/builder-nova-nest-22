        ...
        <div className="container-padding relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-3xl font-bold mb-6">رؤيتن�� للمستقبل</h3>
          ...
          >
            {[
              ...
              },
              {
                ...
                content:
                  "أفضل استثمار قمنا به! الم��قع الإلكتروني الجديد زاد من مبيعاتنا الأونلاين بشكل كبير. شكراً لفريق خطوة المبدع.",
                rating: 5,
                image:
